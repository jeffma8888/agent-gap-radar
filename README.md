...
|---|---|---|
| `REGISTER.md` | The whole register as one ranked document -- what a builder reads before starting a project, with nothing installed and nothing to run. Generated, so never hand-edit it: regenerate with `uv run radar report . > REGISTER.md` | generated by the build loop |
