...
**Next up:** 15 (a shipped wrong output), then 20 (a wrong count in the document a machine consumer reads), then 8, then 9. Then 16, whose never-drop dependency #14 has cleared.
